...
def next_move(snake, food):
    ...
    if x == food.coordinates[0] and y == food.coordinates[1]:
        global score
        if sound_enabled.get() == 1:
            sound = pygame.mixer.Sound("sounds//eatingsound.mp3")
            sound.play()
        score += 1
...
def background_music():
    ...
    if sound_enabled.get() == 1:
        pygame.mixer.music.load("sounds//allgamemusic.mp3")
...
def gameover():
    ...
    if sound_enabled.get() == 1:
        music_file_path = "sounds//gameover.mp3"
        pygame.mixer.init()
...
def reset_game():
    ...
    global direction
    sound_enabled = tk.IntVar(value=1)
    music_file_path = "allgamemusic.mp3"
    background_music()
    # Hide the canvas
    canvas.pack_forget()
...
def settings():
    ...
    global settings_frame, current_resolution_label, sound_enabled
    ...
    sound_checkbox.pack(anchor='center', pady=(0, 70))
    ...
    reset_highestscore_button.pack(pady=(0,70))
