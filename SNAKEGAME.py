...
>>>>>>> d0e492b76e1c9361776f1f084d9c159474411382
...
def next_move(snake, food):
    ...
    if direction == "up":
        ...
        y += SPACE_SIZE
    elif direction == "left":# Import necessary libraries
from tkinter import *
import random
import tkinter as tk
from tkinter import messagebox
...
def next_move(snake, food):
    ...
    if x == food.coordinates[0] and y == food.coordinates[1]:
        ...
        sound = pygame.mixer.Sound("eatingsound.mp3")
        sound.play()
        score += 1
...
def background_music():
    pygame.mixer.init()
    pygame.mixer.music.load("allgamemusic.mp3")
